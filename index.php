...
<body>
      ...
      <div id="content">
            ...
            <!--==============================row_1=================================-->
            <section class="row_1" style="text-align: center;">
                  <div class="container">
                        <article class="row" style="text-align: center;">
                              <div class="col-lg-12" style="text-align: center;">
                                    <div class="box1" style="text-align: center!important;">
                                          <div class="box1txt" style="text-align: center;">
                                                <p class="title1">Sentir el poder de pedalear</p>
                                                <p class="title2">Cada sendero es una invitación a descubrir una nueva aventura.</p>
                                          </div>
        ...
        <div class="container"> 
                                    ...
                                    <article class="col-lg-4 col-md-4 col-sm-6 col-xs-12 racers">
                                          ...
                                          <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 list2col">
                                                      <ul class="list2">
                                                            <li><em><img src="img/bullet1.jpg" alt=""></em>
                                                                  <p><a href="#">Lorem ipsum dolo.</a></p>
                                                            </li>
                                                            <li><em><img src="img/bullet1.jpg" alt=""></em>
                                                                  <p><a href="#">it amet consecte.</a></p>
                                                            </li>
                                                            <li><em><img src="img/bullet1.jpg" alt=""></em>
                                                                  <p><a href="#">consecter posu.</a></p>
                                                            </li>
                                                            <li><em><img src="img/bullet1.jpg" alt=""></em>
                                                                  <p><a href="#">lectus tristique.</a></p>
                                                            </li>
                                                            <li><em><img src="img/bullet1.jpg" alt=""></em>
                                                                  <p><a href="#">iaculis eleif diam.</a></p>
                                                            </li>
                                                      </ul>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 list2col">
            ...
            <!--==============================row_5=================================-->
            <div class="row" style="background-color: #f9f9f9!important;padding: 20px ;">

                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                        <div class="map2">
                              <iframe src="http://maps.google.com/maps?f=q
                              &amp;source=s_q
                              &amp;hl=es
                              &amp;geocode=
                              &amp;q=Neuquen
                              &amp;aq=0
                              &amp;sll=-38.956070,-68.059242
                              &amp;sspn=-38.956070,-68.059242
                              &amp;ie=UTF8
                              &amp;hq=aaaaaaaaaaaa
                              &amp;hnear=Neuquen
                              &amp;ll=-38.956070,-68.059242
                              &amp;spn=-38.956070,-68.059242
                              &amp;z=14
                              &amp;iwloc=A
                              &amp;output=embed">
                              </iframe>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                        ...
                        <div class="map2">
                              ...
                              <iframe class="boxtube1" src="https://www.youtube.com/embed/hKffM02mXjQ?autoplay=1&loop=1&playlist=hKffM02mXjQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay=1; loop=1; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
