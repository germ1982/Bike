...
<div id="content">
    <!--==============================row_14=================================-->   
    <section class="row_14"> 
        <div class="container">
              <div class="row block-404">
                <article class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
                    <figure><img src="img/404.png" alt=""></figure>
                </article>
                <article class="col-lg-5 col-md-6 col-sm-6 col-xs-12 forminfo">
                    <div>
                        <h2 class="title404_1">sorry! page not found!</h2>
                        ...
                        <form id="search-form2" action="search.php" method="GET" accept-charset="utf-8" class="form-404 clearfix" >
                            ...
                            <a href="#" class="btn btn-primary btn2" onClick="document.getElementById('search-form2').submit()">submit</a>
                        </form>
                    </div>
                </article>  
              </div>            
